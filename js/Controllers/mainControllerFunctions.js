...
function controllerFunction($scope, $rootScope, $window, $timeout, $filter, $q, $location, $http, $sce, $mdDialog, $mdToast, $mdSidenav, $mdMedia, $mdTheming, authorizationService, APIService, angularGridInstance) {
   ...
   function getDatabase(argument) {
      //    FireDatabase.ref('posts').on('child_added', function (childSnapshot, prevChildKey) {
      ...
      //    });
      //    FireDatabase.ref('posts').on('child_removed', function (childSnapshot, prevChildKey) {
      //       var val = childSnapshot.val()
      ...
      //       console.log(postMemory)
      //    });
      //    FireDatabase.ref('posts').on('child_changed', function (childSnapshot, prevChildKey) {
      //       var val = childSnapshot.val()
