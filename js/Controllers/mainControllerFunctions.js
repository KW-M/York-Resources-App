...
function generateQueryString() {
   ...
   //    $scope.searchPlaceholder = 'Search Within ' + $scope.queryParams.classpath;
   // }
   if ($scope.queryParams.flagged !== undefined && $scope.queryParams.flagged !== null) {
      query = query + " and properties has { key='Flagged' and value='" + $scope.queryParams.flagged + "' }";
   }
   if ($scope.queryParams.bookmarked !== undefined && $scope.queryParams.bookmarked !== null) {
      query = query + " and fullText contains '" + $scope.queryParams.bookmarked + "'";
   }
   ...
   if ($scope.queryParams.q !== undefined && $scope.queryParams.q !== null) {
